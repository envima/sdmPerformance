...
source(paste0("R/",nameRun,"/functions/generateBackgroundPoints.R"))
source(paste0("R/",nameRun,"/functions/generateAAPoints.R"))
source(paste0("R/",nameRun,"/functions/calculateMetrics.R"))
source(paste0("R/",nameRun,"/functions/indexCalculation.R"))
